...
<head><title>
	Nh&#226;n chứng kể chuyện - Dinh độc lập
</title>
...
<body class="LTR Safari Chrome Safari5 Chrome5 VIVN ContentBody" >
    <form method="post" action="/vi-vn/tin-tuc-su-kien/nhan-chung-ke-chuyen.aspx" id="aspnetForm">
...
//]]>
    ...
    <div id="main_content_sub">
        <div class="container_12">
            <div class="breakcumb">
               <a href="/vi-vn/tin-tuc-su-kien.aspx" class="CMSBreadCrumbsLink">Tin tức - Sự kiện</a>  <img src="bulllet1.jpg" />  <span  class="CMSBreadCrumbsCurrentItem">Nh&#226;n chứng kể chuyện</span>
            </div>
            <!--// end breakcumb-->
            <div class="title_bar">
                <ul class="nav_title">
                ...
                <div class="grid-new">
                    <div class="item">
                        <ul class="news-item">
                                    ...
                                    <li><a class="block" href="/Tin-tuc-Su-kien/Nhan-chung-ke-chuyen/test.aspx">
                                        <div class="news-thumbs" style="background-image:url(/getattachment/9f42c613-37c4-4995-b572-57cdc22190c8/NodeAlias.aspx?width=260&height=);width:260px;background-position:center center;background-repeat:no-repeat">
                                            
                                        </div></a>
                                        <div class="news-info" style="float:left;width:600px;">
                                            <h2><a href="/Tin-tuc-Su-kien/Nhan-chung-ke-chuyen/test.aspx">Ông Vũ Đăng Toàn kể chuyện “khi xe tăng tiến vào Dinh ngày 30/4/1975” </a></h2>
                                            <time>08-04-2014 - 03:21</time>
                                            <div class="news-description">
                                               Ông Vũ Đăng Toàn kể chuyện “khi xe tăng tiến vào Dinh ngày 30/4/1975” 
                                            </div>
                                            <a href="/Tin-tuc-Su-kien/Nhan-chung-ke-chuyen/test.aspx" class="btn_more">Xem thêm</a>
                                        </div>  
                                        <div style="clear:both"></div>                                      
                                    </li>
                                
                                    <li><a class="block" href="/Tin-tuc-Su-kien/Nhan-chung-ke-chuyen/Chuyen-ke-ve-vu-nem-bom-ngay-8-4-1975.aspx">
                                        <div class="news-thumbs" style="background-image:url(/getattachment/f6d8ccc3-6b28-4358-a24b-e1aeb32fe28d/NodeAlias.aspx?width=260&height=);width:260px;background-position:center center;background-repeat:no-repeat">
                                            
                                        </div></a>
                                        <div class="news-info" style="float:left;width:600px;">
                                            <h2><a href="/Tin-tuc-Su-kien/Nhan-chung-ke-chuyen/Chuyen-ke-ve-vu-nem-bom-ngay-8-4-1975.aspx">Chuyện kể về “vụ ném bom ngày 8/4/1975”</a></h2>
                                            <time>25-06-2014 - 04:00</time>
                                            <div class="news-description">
                                               Chuyện kể về “vụ ném bom ngày 8/4/1975”
                                            </div>
                                            <a href="/Tin-tuc-Su-kien/Nhan-chung-ke-chuyen/Chuyen-ke-ve-vu-nem-bom-ngay-8-4-1975.aspx" class="btn_more">Xem thêm</a>
                                        </div>  
                                        <div style="clear:both"></div>                                      
                                    </li>

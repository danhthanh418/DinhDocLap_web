...
<body>
    ...
    <div id="main_content">
        ...
        <div class="content2">
            <div class="container_12">
                <div class="grid_12">
                    <h1 class="ct_title"><a>Tư liệu</a></h1>
                    <div class="clearfix"></div>
                    <div class="breakcumb2">                           
                        <a href="#" class="CMSBreadCrumbsLink">Hình ảnh - Tư liệu</a> &nbsp;<img src="../assets/img/bulllet1.jpg">&nbsp; <span class="CMSBreadCrumbsCurrentItem">Tư liệu</span>
                    </div><!--// end breakcumb-->  
                    <div class="clearfix"></div>
                    <div class="wrap_primary">
                        <div class="cpri">
                           <div class="scroll-pane" style="overflow: hidden; padding: 0px; width: 939px;">
                                <!--end group_pic-->                                    
                           <div class="jspContainer" style="width: 939px; height: 300px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 939px;"><div class="group_pic">
                                    <ul class="list_pic">
                                        
                                                <li><a href="./tu-lieu/dinh-norodom.php">
                                                    <div class="ct_img" style="background: url(../assets/img/getattachment/norodom.jpg) no-repeat center center; width: 232px; height: 158px;">
                                                        <div class="img_hover" style="background: url(../assets/img/img_hover2.png) no-repeat center center; width: 232px; height: 115px;">
                                                        </div>
                                                ...
                                                <li><a href="./tu-lieu/dinh-doc-lap-truoc-30-4.php">
                                                    <div class="ct_img" style="background: url(../assets/img/getattachment/Dinh.jpg) no-repeat center center; width: 232px; height: 158px;">
                                                        <div class="img_hover" style="background: url(../assets/img/img_hover2.png) no-repeat center center; width: 232px; height: 115px;">
                                                        </div>
                                                        <div class="caption">
                                                            <p>Dinh Độc Lập</p>
                                                ...
                                                <li><a href="./tu-lieu/dinh-doc-lap-sau-30-4.php">
                                                    <div class="ct_img" style="background: url(../assets/img/getattachment/hinh-42.jpg) no-repeat center center; width: 232px; height: 158px;">
                                                        <div class="img_hover" style="background: url(../assets/img/img_hover2.png) no-repeat center center; width: 232px; height: 115px;">
                                                        </div>
                                                        <div class="caption">
                                                            <p>Dinh Độc Lập từ 30/4/1975 đến nay</p>
                                                        </div>
                                                    </div>
                                                </a></li>

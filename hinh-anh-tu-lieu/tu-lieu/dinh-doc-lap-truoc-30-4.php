...
<head>
    ...
    <title>Sau 30/4 - Dinh Độc Lập</title>
    ...
    <link rel="stylesheet" type="text/css" href="../../assets/js/source/helper/jquery.fancybox-buttons.css" />
    <script type="text/javascript" src="../../assets/js/source/helper/jquery.fancybox-buttons.js"></script>
                    ...
                    <ul class="menu">
                            ...
                            <div class="sub-menu2">
                                ...
                                <div class="nav_col">
                                    <div class="n_img" style="background: url(../../assets/img/getattachment/Khanh-tiet.jpg) no-repeat center center; width: 195px; height: 85px;">
                                        <a href="../../trung-bay/co-dinh.html" class="icon_hover"></a>
                                    </div>
                                    <div class="nav_caption">
                                        <a href="../../trung-bay/co-dinh.html">Cố định</a>
                                    </div>
                                </div>

                                <div class="nav_col">
                                    <div class="n_img" style="background: url(../../assets/img/getattachment/mang-3.jpg) no-repeat center center; width: 195px; height: 85px;">
                                        <a href="../../trung-bay/chuyen-de.html" class="icon_hover"></a>
                                    </div>
                                    <div class="nav_caption">
                                        <a href="../../trung-bay/chuyen-de.html">Chuyên đề</a>
                                    </div>
                                </div>

                                <div class="nav_col">
                                    <div class="n_img" style="background: url(../../assets/img/getattachment/nav2.jpg) no-repeat center center; width: 195px; height: 85px;">
                                        <a href="../../trung-bay/bo-sung.html" class="icon_hover"></a>
                                    </div>
                                    <div class="nav_caption">
                                        <a href="../../trung-bay/bo-sung.html">Bổ sung</a>
                                    </div>
                                </div>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="../../tham-quan/duong-di-den-di-tich.html">
                                        Đường đi đến di tích</a>
                                </li>

                                <li>
                                    <a href="../../tham-quan/gia-ve.html">
                                        Giờ mở cửa, giá vé tham quan</a>
                                </li>

                                <li>
                                    <a href="../../tham-quan/noi-quy-tham-quan.html">
                                        Nội quy tham quan</a>
                                </li>

                                <li>
                                    <a href="../../tham-quan/thong-bao.html">
                                        Thông báo</a>
                                </li>
                        ...
                        <li class="nav-act">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="../../hinh-anh-tu-lieu/hinh-anh.html">
                                        Hình ảnh</a>
                                </li>

                                <li>
                                    <a href="../../hinh-anh-tu-lieu/tu-lieu.html">
                                        Tư liệu </a>
                                </li>
                ...
                <div class="content" style="background: url(../../assets/img/bg_content.png) repeat; margin: -33px 0 0 0; padding: 84px 0 0 0; min-height: 542px;">
                    <div class="container_12">
                        ...
                        <div class="breakcumb2">
                            ...
                            <img src="../../assets/img/icon/bulllet1.jpg" />
                            <a class="CMSBreadCrumbsCurrentItem" href="./dinh-doc-lap-sau-30-4.html">Dinh Độc Lập trước 30/4/1975</a>
                        </div>
                        <!--// end breakcumb-->
                        <div class="clearfix"></div>
                    <div class="wrap_primary">
                        <div class="lpri">
                            <div class="iner_lpri" style="background-color:black;">
                                <div class="scroll-pane">
                                    <h1><a id="slider_caption"></a></h1>
                        ...
                        <!--end lpri-->
                        <div class="rpri grid_9 alpha omega">
                            <div class="iner_rpri">
                                <div class="pri_slider" style="background-color:black;">
                                    <div class="cycle-slideshow"
                                        data-cycle-timeout="0"
                                        data-cycle-next="#next"
                                        data-cycle-prev="#prev"
                                        data-cycle-fx="tileBlind"
                                        data-cycle-caption="#slider_caption"
                                        data-cycle-caption-template="{{alt}}"
                                        data-cycle-tile-count="15">
                                        <img alt="Công văn số 424-TTP/KT ngày 26/2/1964 v/v chỉ thị cho Quản đốc công trường tái thiết Dinh Độc Lập v/v tái khởi công tác tái thiết Dinh Độc Lập và tiếp tục lo công tác khai thác đá hoa vùng Biên Hòa (núi Châu Thới) để dùng vào công tác tái thiết Dinh Độc Lập…" 
                                        src="../hinh-anh/dinh-doc-lap/img1.jpg" width="492" height="347">
                                        <img alt="Thông tư số 1658-BNV/HC.12 của Bộ trưởng Bộ Nội Vụ gửi các Đô trưởng, Thị trưởng, Tỉnh trưởng về việc lạc quyên xây dựng Dinh Độc Lập" 
                                        src="../hinh-anh/dinh-doc-lap/img2.jpg" width="492" height="347">
                                        <img alt="V/v mang thẻ kiểm soát ra vào Dinh Độc Lập năm 1973" 
                                        src="../hinh-anh/dinh-doc-lap/img3.jpg" width="492" height="347">
                                        <img alt="Thông tư về việc cách ăn mặc khi vào Dinh Độc Lập" 
                                        src="../hinh-anh/dinh-doc-lap/img4.jpg" width="492" height="347">                                     
                                    </div>

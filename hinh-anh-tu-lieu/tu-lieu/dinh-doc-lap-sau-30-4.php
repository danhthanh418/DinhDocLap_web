...
<head>
    ...
    <title>Trước 30/4 - Dinh Độc Lập</title>
            ...
            <div id="main_content">
                ...
                <div class="content" style="background: url(../../assets/img/bg_content.png) repeat; margin: -33px 0 0 0; padding: 84px 0 0 0; min-height: 542px;">
                    <div class="container_12">
                        <h1 class="ct_title">
                            <a>
                                Dinh độc lập từ 30/04/1975 đến nay
                            </a>
                        </h1>
                        <div class="clearfix"></div>
                        <div class="breakcumb2">
                            ...
                            <img src="../../assets/img/icon/bulllet1.jpg" />
                            <a class="CMSBreadCrumbsCurrentItem" href="./dinh-doc-lap-sau-30-4.php">Dinh Độc Lập từ sau 30/4/1975 đến nay</a>
                        </div>
                        <!--// end breakcumb-->
                        <div class="clearfix"></div>
                            ...
                            <div class="rpri grid_9 alpha omega">
                                <div class="iner_rpri">
                                    <div class="pri_slider" style="background-color:black;">
                                        <div class="cycle-slideshow" data-cycle-timeout="0" data-cycle-next="#next" data-cycle-prev="#prev" data-cycle-fx="tileBlind"
                                            data-cycle-caption="#slider_caption" data-cycle-caption-template="{{alt}}" data-cycle-tile-count="15">
                                            <img alt="Quyết định về việc phê duyệt chủ trương lập đề án, nhiệm vụ quy hoạch chi tiết xây dựng 1/500 bảo tồn, tôn tạo Di tích lịch sử DInh Độc Lập"
                                                src="../hinh-anh/dinh-doc-lap-sau-30-4/sau304-1.jpg" width="492" height="347">
                                            <img alt="Quyết định về việc xếp hạng Di tích quốc gia đặc biệt" 
                                            src="../hinh-anh/dinh-doc-lap-sau-30-4/sau304-2.jpg" width="492"
                                                height="347">
                                        </div>

                        ...
                        <div class="rpri grid_9 alpha omega">
                            <div class="iner_rpri">
                                <div class="pri_slider" style="background-color:black;">
                                    ...
                                    <img alt="Dinh Thống đốc Nam kỳ  (còn được gọi là Dinh Norodom) được xây dựng từ 1868 – 1871 theo đề án của kiến trúc sư Achille – Antoine  Hermitte" 
                                    src="./dinh-norodom/img0.jpg" width="492" height="347">
                                    <img alt="Diễu hành tại Dinh Norodom 5/1956" 
                                    src="./dinh-norodom/img1.jpg" width="492" height="347">
                                    <img alt="Dinh Norodom năm 1962" 
                                    src="./dinh-norodom/img2.jpg" width="492" height="347">
                                    <img alt="Bà Trần Lệ Xuân kiểm tra Dinh Norodom sau khi bị ném bom 27/2/1962" 
                                    src="./dinh-norodom/img3.jpg" width="492" height="347">
                                    <img alt="Dinh Norodom về đêm" 
                                    src="./dinh-norodom/img4.jpg" width="492" height="347">
                                    <img alt="Toàn cảnh Dinh Norodom từ trên cao" 
                                    src="./dinh-norodom/img5.jpg" width="492" height="347">  
                                    </div>

            ...
            <div id="navigation">
                <div class="container_12">
                    <ul class="menu">
                        ...
                        <li class=""><a href="./../ve-chung-toi/so-do-to-chuc/so-do-to-chuc.php">
                                    Về chúng tôi</a>
                            <ul class="sub-menu">
                ...
                <div class="content" style="background: url(../../assets/img/bg_content.png) repeat; margin: -33px 0 0 0; padding: 84px 0 0 0; min-height: 542px;">
                    <div class="container_12">
                        ...
                        <div class="breakcumb2">
                            ...
                            <img src="../../assets/img/icon/bulllet1.jpg" />
                            <a class="CMSBreadCrumbsCurrentItem" href="./dinh-doc-lap-sau-30-4.php">Dinh Độc Lập trước 30/4/1975</a>
                        </div>
                        <!--// end breakcumb-->
                        <div class="clearfix"></div>
                            ...
                            <div class="iner_rpri">
                                <div class="pri_slider" style="background-color:black;">
                                    <div class="cycle-slideshow"
                                        ...
                                        <img alt="Lễ khánh thành Dinh Độc Lập ngày 31/10/1966" 
                                        src="./dinh-doc-lap-truoc-30-4/img1.jpg" width="492" height="347">
                                        <img alt="Lễ cắt băng khánh thành Dinh Độc Lập 31/10/1966" 
                                        src="./dinh-doc-lap-truoc-30-4/img2.jpg" width="492" height="347">                                      
                                    </div>

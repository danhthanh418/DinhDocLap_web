...
<body class="LTR Safari Chrome Safari5 Chrome5 VIVN ContentBody" >
    <form method="post" action="/vi-vn/ve-chung-toi.aspx" id="aspnetForm">
...
//]]>
            ...
            <div class="container_12">
                ...
                <div class="r_header grid_3 push_3 omega">
                    ...
                    <div class="lang" style="position:relative;">
                        <div style="position:absolute;right:105px;top:0;width:180px;background-image:url(/App_Themes/chuyen.png);background-position:left center;background-repeat:no-repeat;padding-left:15px;">
                            <a href="http://dichvu.dinhdoclap.gov.vn" style="color:#725D02;font-family:Tahoma;font-size:11px;font-weight:bold">
                                Trang dịch vụ Dinh Độc Lập
                            </a>
                        </div>
                        <span class="vn"><a class='lang_act' href="/vi-vn/ve-chung-toi.aspx?lang=vi-VN">Vietnamese</a></span>
                        <span class="en"><a class='' href="/vi-vn/ve-chung-toi.aspx?lang=en-US">English</a></span>
                    </div>
        ...
        <div id="container">
            ...
            <div id="navigation">
                <div class="container_12">
                        ...
                        <li class="nav-act"><a href="./ve-chung-toi.php">
                                    Về chúng tôi</a>
                            <ul class="sub-menu">
    ...
    <style type="text/css">
        ...
        {
            left: 300px;
            background: url(./assets/img/icon/prev.png) no-repeat 0 0;
            width: 21px;
            height: 32px;
        }
            ...
            .tb_prev:hover
            {
                background: url(./assets/img/icon/prev_hover.png) no-repeat 0 0;
            }

        .tb_next
        {
            right: 50px;
            background: url(./assets/img/icon/next.png) no-repeat 0 0;
            width: 21px;
            height: 32px;
        }
            ...
            .tb_next:hover
            {
                background: url(./assets/img/icon/next_hover.png) no-repeat 0 0;
            }
    </style>
    <div id="main_content">
        <div class="content" style="background: url(./assets/img/bg_content.png) repeat; margin: -33px 0 0 0; padding: 84px 0 0 0; min-height: 542px;">
            <div class="container_12">
                ...
                <div class="breakcumb2">
                   <span  class="CMSBreadCrumbsCurrentItem">Về ch&#250;ng t&#244;i</span>
                </div>
                <!--// end breakcumb-->
                <div class="clearfix"></div>
                ...
                <div class="wrap_primary">
                    <div class="html_carousel">
                        <div id="foo1">
                            ...
                            <div class="slide"><div style="width: 720px; height: 347px; float: right; background: #000; padding: 2px 0">
                                <div style="width:720px;height:347px;float:right;background-image:url(.../../assets/img/getattachment/so-do.jpg);background-position:center center;background-repeat:no-repeat">
                                </div>
                                </div>
